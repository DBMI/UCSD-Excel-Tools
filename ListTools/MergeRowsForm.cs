...
namespace ListTools
{
    ...
    System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        private void PopulateDateColumns()
        {
            ...
            List<string> availableSourceColumns = availableSourceColumnsRangeDict.Keys.ToList();
            availableSourceColumns = availableSourceColumns.Except(selectedPatientDefnColumns).ToList();
            availableSourceColumns = availableSourceColumns.Except(selectedInfoColumns).ToList();
        ...
        private void PopulateInfoColumns()
        {
            ...
            availableSourceColumns = availableSourceColumns.Except(dateColumns).ToList();
