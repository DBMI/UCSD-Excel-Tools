...
namespace UCSD_Notes_Tools
{
    public partial class MergeNotesForm : Form
    {
        ...
        private void PopulateDateColumn()
        {
            ...
            List<string> availableSourceColumns = availableSourceColumnsDict.Keys.ToList();
            availableSourceColumns = availableSourceColumns.Except(selectedSourceColumns).ToList();
            availableSourceColumns = availableSourceColumns.Except(new List<string> { selectedIndexColumn }).ToList();
        ...
        private void PopulateIndexColumns()
        {
            ...
            List<string> availableSourceColumns = availableSourceColumnsDict.Keys.ToList();
            availableSourceColumns = availableSourceColumns.Except(selectedSourceColumns).ToList();
            availableSourceColumns = availableSourceColumns.Except(new List<string> { selectedDateColumn }).ToList();
